     ...
     <footer className="py-12 bg-gray-900 text-gray-300">
        <div className="container px-4 mx-auto">
          <div className="grid gap-8 md:grid-cols-4">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold text-white">TrippGo</span>
              </div>
              <p className="mb-4">Making travel planning simple, enjoyable, and accessible for everyone.</p>
            ...
            <div>
              ...
              <p className="mb-4">Subscribe to our newsletter for travel tips and exclusive deals.</p>
              <div className="flex">
          ...
          <div className="pt-8 mt-8 text-sm text-center border-t border-gray-800">
            <p>© {new Date().getFullYear()} TripWise. All rights reserved.</p>
          </div>
        </div>
      </footer>
  )
